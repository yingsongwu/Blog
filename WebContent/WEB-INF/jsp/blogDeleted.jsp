   ...
   ================================================== -->
					...
					function delBlogById(b_id) {
						...
						$.ajax({
							...
							success:function(data){
								...
								//alert("#blog"+b_id);
								$("#blog"+b_id).remove();
								window.location="${pageContext.request.contextPath}/BlogController/blogDelete.action";
							}
						}); 
					};
				</script>
	...
	<div class="row">
   		<nav class="pagination">
            ...
            <a href="${pageContext.request.contextPath }/BlogController/blogDeletedBypage.action?page=${i}" ><span class="page-numbers current"><c:out value="${i}" /> </span> </a> 
            </c:forEach>  
	      </nav>
   	</div>
