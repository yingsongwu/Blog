...
<body id="top">
   ...
   ================================================== -->
	...
	<div class="wraper">
		<div class="nav">
			<ul>
				<li class="nav-item"><a href="" target="_blank">文章管理</a></li>
				<li class="nav-item"><a href="" target="_blank">类别管理</a></li>
				<li class="nav-item"><a href="" target="_blank">评论管理</a></li>
				<li class="nav-item"><a href="" target="_blank">博客配置</a></li>
				<li class="nav-item"><a href="" target="_blank">博客栏目</a></li>
				<li class="nav-item"><a href="" target="_blank">草稿箱</a></li>
				<li class="nav-item"><a href="" target="_blank">回收站</a></li>
				<li class="nav-item cur"><a href="" target="_blank">写博客</a></li>
			</ul>
			<!--移动的滑动-->
			...
			<div>
				<div>
					<input class="full-width" type="email"
						placeholder="${requestScope.blog.b_title}" id="inputTitle">
					<input class="full-width" type="email"
						placeholder="${requestScope.blog.b_info}" id="inputInfo">
				</div>

				<!-- editor.md -->
				<div class="editormd" id="test-editormd">
					<textarea style="display: none;">${requestScope.blog.b_srcText}</textarea>
				</div>

				<!-- editor.md -->

				<a class="button full-width" onclick="blogSave();">保存</a> <a
					class="button button-primary full-width" onclick="blogSubmit();">提交</a>
			</div>
</body>
...
<script type="text/javascript">
	...
	function blogSubmit() {
		//获取界面中的博客
		var b_id = "${requestScope.blog.b_id}";
		...
		$
				.ajax({
					type : "post",
					url : "${pageContext.request.contextPath}/BlogController/updateBlog.action",
		...
		$
				.ajax({
					...
					success : function(data) {
						if (data) {
							alert("博客保存成功");
							window.location.href = '${pageContext.request.contextPath}/BlogController/blogDraft.action';
						} else {
							alert("博客保存失败");
						}
					}
...
<div class="footer-bottom">
	<div class="row">
		...
		<div class="col-twelve">
			<div class="copyright">
				<span>© Copyright Abstract 2016</span> <span>More Templates <a
