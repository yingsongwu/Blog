...
<body id="top">
   ...
   ================================================== -->
	...
	<div class="row header-content">
		...
		<ul class="main-navigation sf-menu">
			...
			<li><a href="${pageContext.request.contextPath }/BlogController/blogList.action">我的博客</a></li>
   ...
   ================================================== -->
		...
		<div class="bricks-wrapper">
			...
			<c:forEach items="${requestScope.list}" var="name">
				...
				<div class="entry-thumb">
					<a
						href="${pageContext.request.contextPath }/BlogController/ShowBlogText1.action?b_id=${name.b_id}"
						class="thumb-link"> <img src="../images/thumbs/${name.p_url}"
						alt="building" width="500" height="">
					</a>
				</div>
	...
	<div class="row">
		...
		<a href="${pageContext.request.contextPath }/BlogController/ShowBlogBypage.action?page=1" ><span class="page-numbers current">首页</span> </a> 
		   	<c:forEach var="i" begin="1" end="${requestScope.pageCount }" step="1">   
            <a href="${pageContext.request.contextPath }/BlogController/ShowBlogBypage.action?page=${i}" ><span class="page-numbers current"><c:out value="${i}" /> </span> </a> 
               </c:forEach> 
                <a href="${pageContext.request.contextPath }/BlogController/ShowBlogBypage.action?page=${requestScope.pageCount }" ><span class="page-numbers current">尾页</span> </a>   </nav>
