...
<body id="top">
   ...
   ================================================== -->
		...
		<div class="bricks-wrapper">
			...
			<c:forEach items="${requestScope.list}" var="name">
				...
				<div class="entry-thumb">
					<a
						href="${pageContext.request.contextPath }/BlogController/ShowBlogText.action?b_id=${name.b_id}"
	...
	<div class="row">
		...
		<nav class="pagination"> <c:forEach var="i" begin="1"
			end="${requestScope.pageCount }" step="1">
			<a
				href="${pageContext.request.contextPath }/BlogController/ShowBlogSearch1.action?s=${requestScope.s }&page=${i}"><span
